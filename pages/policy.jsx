        ...
        <main className="page">
          <div className="policy">
            <div className="policy__container">
              <h1>Privacy Policy for figmamakets</h1>

              <p>
                At figmamakets, accessible from figmamakets.com, one of our main priorities is the
                privacy of our visitors. This Privacy Policy document contains types of information
                that is collected and recorded by figmamakets and how we use it.
              </p>
              ...
              <p>
                ...
                figmamakets. This policy is not applicable to any information collected offline or
              ...
              <p>
                figmamakets follows a standard procedure of using log files. These files log
              ...
              <p>
                ...
                on figmamakets, which are sent directly to users' browser. They automatically
              ...
              <p>
                Note that figmamakets has no access to or control over these cookies that are used
              ...
              <p>
                figmamakets's Privacy Policy does not apply to other advertisers or websites. Thus,
              ...
              <p>
                figmamakets does not knowingly collect any Personal Identifiable Information from
